...
7. 评分项名称必须逐字复制评分表中对应的评审因素名称，只允许删除序号、换行、末尾单独标注的分值，以及标题末尾仅表示评分方式的“（客观分）”“（主观分）”；不得删除“项目”“本项目”“服务”“保障”等原文词语，不得从评分标准正文归纳或重写评分项名称。例如，“项目实施方案”不得改写为“实施方案”。
8. 不得把多条评分标准概括成摘要；“项目实施过程中”“服务需求中”等范围限定词必须保留在完整评分原文中。
9. 对每条评分行识别其中明确要求投标人响应的内容，例如“政策背景”“项目技术要求理解”“建设目标”“技术路线”，原文未列出时不要编造。
...
【权重/分值】：<具体分值或占比>
【评分标准】：<完整评分原文，不概括、不合并>
【评分行】：<按原顺序逐条列出独立评分行；没有更细评分行时填写评分项原文>
【明确响应内容】：<逐项列出评分行中要求响应的具体内容；没有明确列举时写“未明确列举”>
【数据来源】：<章节、条款、页码或表格位置>
