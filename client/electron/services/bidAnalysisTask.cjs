...
5. 对每个技术评分项，必须记录它在评分表中明确存在且有业务含义的直接上级分组；“技术方案（40分）”“技术评分”“技术部分”“技术标”等通用类别或总分表头不属于业务分组。原文没有明确业务分组时写“无”，禁止根据评分项语义或相邻关系推断分组。
6. 评分项名称必须逐字复制评分表中对应的评审因素名称，只允许删除序号、换行和末尾单独标注的分值；不得删除“项目”“本项目”“服务”“保障”等原文词语，不得从评分标准正文归纳或重写评分项名称。例如，“项目实施方案”不得改写为“实施方案”。
