...
const bridge = {
  ...
  technicalPlan: {
    ...
    aiEditContent: (payload) => ipcRenderer.invoke('technical-plan:ai-edit-content', payload),
    generateInlineImage: (payload) => ipcRenderer.invoke('technical-plan:generate-inline-image', payload),
    importInlineImage: (payload) => ipcRenderer.invoke('technical-plan:import-inline-image', payload),
    releaseInlineImageCandidate: (payload) => ipcRenderer.invoke('technical-plan:release-inline-image-candidate', payload),
