...
export interface YibiaoBridge {
  ...
  technicalPlan: {
    ...
    resetIllustrationReviewItem: (payload: { projectId?: string; itemId: string }) => Promise<Partial<TechnicalPlanState>>;
    convertMermaidIllustrationReviewItem: (payload: { projectId?: string; itemId: string; instruction?: string }) => Promise<Partial<TechnicalPlanState>>;
