...
export function getFoldersForKnowledgeBase(index: KnowledgeBaseIndex, knowledgeBaseId: KnowledgeBaseId | ''): KnowledgeFolder[] {
...
export function mergeFolderDocumentSelection(
  ...
  if (folderDocumentIds.size === 0) {
    return [...new Set(currentDocumentIds)];
  }
